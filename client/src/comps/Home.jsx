...
class Home extends Component {
  ...
  async getTranscript(transcribe_id) {
    ...
    if (result.data.status !== 'completed') {
      setTimeout(() => {
        this.getTranscript(transcribe_id)
      }, 5000);
    } else {
      ...
      <div className="login">
        ...
        <div className="article">
          <div className="col1">
            ...
            In the U.S. and much of the developed world, mental disorders are one of the leading causesTrusted Source of
            disability.

            Social and financial circumstances, biological factors, and lifestyle choices can all shape a person’s
            mental health.
          ...
          <div className="col2">
            Having limited financial means or belonging to a marginalized or persecuted ethnic group can increase the
            risk of mental health disorders.

            A 2015 studyTrusted Source of 903 families in Iran identified several socioeconomic causes of mental health
            conditions, including poverty and living on the outskirts of a large city.

            The researchers also explained the difference in the availability and quality of mental health treatment for
            certain groups in terms of modifiable factors, which can change over time, and nonmodifiable factors, which
            are permanent.


          </div>
          <div className="col3">
            The NIMH suggest that genetic family history can increase the likelihoodTrusted Source of mental health
            ...
            Having a gene with links to a mental health disorder, such as depression or schizophrenia, does not
            guarantee that a condition will develop. Likewise, people without related genes or a family history of
            mental illness can still have mental health issues.

            Mental health conditions such as stress, depression, and anxiety may develop due to underlying,
            life-changing physical health problems, such as cancer, diabetes, and chronic pain.
          </div>
        </div>


        <p className="line"> Suicide prevention hotline: <a
          href="https://suicidepreventionlifeline.org/">800-273-8255</a></p>
        <p className="line"><a
